package com.threecat.springboot.redpacket.redis;
...
public class RedisClient
{
	...
	public boolean setBit(String key, long offset, boolean value) {
		Boolean flag = stringRedisTemplate.opsForValue().setBit(key, offset, value);
	...
	public <T> T execute(RedisScript<T> script, List<String> params)
	{
		return stringRedisTemplate.execute(script, params);
	}
	//    /**
	//     * 获取Redis List 序列化
	//     * @param key
